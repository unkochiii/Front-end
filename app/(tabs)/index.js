...
const styles = StyleSheet.create({
    ...
    coverPlaceholder: { width: 220, height: 320, borderRadius: 16, marginBottom: 16, backgroundColor: "#F0F0F0" },
    cardTitle: { fontSize: 20, fontWeight: "800", textAlign: "center", color: "#000", letterSpacing: -0.3 },
    cardAuthor: { fontSize: 14, color: "#666", marginTop: 6, fontWeight: "500" },

    counter: { textAlign: "center", marginTop: 16, color: "#999", fontSize: 15, fontWeight: "600" },

    actions: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 20, paddingHorizontal: 8 },
    circle: {
        width: 60,
        height: 60,
        borderRadius: 30,
    ...
    primaryText: { color: "white", fontWeight: "800", fontSize: 16, letterSpacing: 0.5 },
    ...
    badgeText: { color: "white", fontWeight: "900", letterSpacing: 1.5, fontSize: 13 },
});
